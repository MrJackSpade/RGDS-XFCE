...
bool ScreenPanelGL::createContext()
{
    ...
    {
        std::array<GL::Context::Version, 5> versionsToTry = {
                GL::Context::Version{GL::Context::Profile::Core, 4, 3},
                GL::Context::Version{GL::Context::Profile::Core, 3, 2},
                GL::Context::Version{GL::Context::Profile::ES, 3, 2},
                GL::Context::Version{GL::Context::Profile::ES, 3, 1},
                GL::Context::Version{GL::Context::Profile::ES, 3, 0}};
        if (windowinfo.has_value())
