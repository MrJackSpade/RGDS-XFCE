...
namespace melonDS
{
const char* kCompositorVS = R"(#version 310 es
...
const char* kCompositorFS_Nearest = R"(#version 310 es
precision mediump float;
precision highp int;
...
const char* kCompositorFS_Linear = R"(#version 310 es
precision mediump float;
precision highp int;
precision lowp usampler2D;
precision lowp sampler2D;
...
const char* kCompositorVS_xBRZ = R"(#version 310 es
precision mediump float;
precision highp int;
...
const char* kCompositorFS_xBRZ = R"(#version 310 es
precision mediump float;
precision highp int;
precision lowp usampler2D;
precision lowp sampler2D;
