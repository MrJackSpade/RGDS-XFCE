...
#if !defined(APPLE_AARCH64) && !defined(__NetBSD__) && !defined(__OpenBSD__) && !defined(__aarch64__)
...
void Init()
{
    ...
    if (RefCounter == 1)
    {
        ...
        #elif defined(APPLE_AARCH64) || defined(__NetBSD__) || defined(__OpenBSD__) || defined(__aarch64__)
